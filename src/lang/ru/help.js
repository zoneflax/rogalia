...
T.help = {
    ...
    combos: {
        ...
        nya: {
            desc: "Аое Баф",
            effect: "+шанс крита для [де], +поглощение для [су]",
        },
        ikkyo: {
            desc: "Удар",
            effect: "агро моба на себя, в пвп 50% стан 1-5 сек",
        },
        shihonage: {
            desc: "Удар",
            effect: "много урона, замедление на 5 сек",
        },
        iriminage: {
            desc: "Удар",
            effect: "20% стан на 2 сек",
        },
    },
};
