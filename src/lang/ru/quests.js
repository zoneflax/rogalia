...
Quest.quests =  {
    ...
    "garland-daily": {
        ...
        desc: [
            "Я тебе не сказал – но праздник в этом году может не состояться… Как-как? Каком кверху",
    ...
    "chrismas-flags-daily": {
        ...
        desc: [
            ...
            "Ты, наверняка, слышал, в каких добрых отношениях находятся наш Зимний Остров и ваши Дикие Земли. Так вот - эти отношения под угрозой!",
            ...
            "Мои люди ждут сейчас сигнала в лесу. Нужно передать им вот это донесение. Справишься? Стой! Не бери его в руки пока что!",
