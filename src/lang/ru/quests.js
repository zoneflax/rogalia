...
Quest.quests =  {
    "tutorial-start": {
        ...
        desc: [
            ...
            "По завершению ты получишь награду: <i>3000 опыта и 8 золотых монет</i>.",
    ...
    "stat-1": {
        voice: true,
        name: "Жажда" ,
        desc: "Теперь я научу тебя, как добывать еду и воду. В следующей комнате ты найдешь небольшой водоем. Сорви кору с дерева и сделай кружку, затем наполни ее водой из источника. Не волнуйся, вода здесь чистая.",
        tip: "Встаньте в воду и <rmb>Заполнить</rmb>.<br><rmb>Пить</rmb> по кружке увеличит вашу выносливость.",
    },
    "stat-2": {
        voice: true,
        name: "Голод" ,
        desc: "Самое время добыть еды и поесть. Нарви яблок с дерева.<br> Будь внимателен, <i>не переедай, иначе еда не принесет тебе пользы в виде витаминов</i>.<br>Если ты вдруг переел, туалет тут рядом, воспользуйся им.",
    },
    "fight": {
        voice: true,
        name: "Бой и боевые комбинации" ,
        desc: "Вот ты и готов к своему первому бою.<br><hl>Возьми в правую руку свою острую палку и ударь манекен.</hl>",
        tip: "Удара выполняется в сторону указателя мыши.<br>Кнопки и хоткеи боевых умений находятся на нижней панели.",
    },
    "finish": {
        voice: true,
        name: "Конец обучения" ,
        desc: "Ну вот я и обучил тебя основам выживания в этих землях.<br>Пора отправляться в город.",
    },
    "faction-daily-1": {
