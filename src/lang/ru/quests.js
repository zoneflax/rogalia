...
Quest.quests =  {
    "tutorial-start": {
        ...
        final: "Отлично, приступим.",
    },
    "craft-1": {
        name: "Сбор ресурсов" ,
        desc: [
            "Для выживания в этих диких землях тебе необходимы инструменты, а чтобы их создать, нужны ресурсы.",
            "Собери четыре камня, два сучка и веточку.",
        ],
        tip: "По дереву: <rmb>Сорвать сук/ветку</rmb>.<br>Собрать камни с земли <lmb></lmb>.",
    },
    "craft-1-2": {
    ...
    "craft-2": {
        ...
        tip: "<lmb></lmb> по иконке острого камня или откройте меню крафта и найдите рецепт через поиск.",
    },
    "craft-2-1": {
        name: "Делаем нож" ,
    ...
    "craft-3": {
        name: "Делаем оружие" ,
        desc: "Хорошо, теперь возьми в руку нож и скрафти острую палку — твое первое оружие. Оно тебе понадобится позже.",
        tip: "<rmb>Экипировать</rmb> по ножу.",
    },
    "stat-1": {
        name: "Жажда" ,
    ...
    "stat-2": {
        name: "Голод" ,
        desc: [
            "Самое время добыть еды и поесть. Нарви яблок с дерева.",
            "<hl>Будь внимателен, не переедай, иначе еда не принесет тебе витаминов, и ты станешь медленным</hl>.",
            "Если ты вдруг переел, туалет тут рядом, воспользуйся им.",
        ]
    },
    "fight": {
    ...
    "finish": {
        ...
        final: "Пора отправляться в город. Там многие могут тебя чему-то научить. Можешь начать с банкира Скруджа",
    },
    "claim-get-license": {
        name: "Лицензия",
        desc: "Привет, новенький. В этом мире всё основано на деньгах. А деньги лучше не оставлять на дороге. Сейчас я научу тебя защищать своё имущество. Помимо того, что деньги можно хранить у меня в банке - стоит оберегать и своё имущество. Для этого существует Клейм.",
        tip: "Получить лицензию можно у Скруджа. Пункт \"Банк\".",
    },
    "claim-build": {
        name: "Строим",
        desc: [
            "Лицензия стоит денег, да, но Клейм сможет тебя защитить, а это главное.",
            "Ты можешь построить Клейм в любом не занятом другими клеймами месте, а затем расширять его.",
            "Не спеши. Выбирай место с умом. Если ты захочешь переставить его или купить ещё один - это будет стоить дополнительных денег.",
            "И построй рядом респаун, чтобы не потерять свой клейм и иметь возможность вернуться к нему.",
        ],
    },
    "claim-extend": {
        name: "Расширяем",
        desc: "Молодец. Клейм можно расширять, но повышается арендная плата за него. Будь аккуратен - проверяй сколько денег лежит у тебя в банке и хватает ли их для продления арендной платы. Иначе ты рискуешь остаться без защиты и потерять всё своё имущество.",
        final: "Готово. Теперь ты можешь смело обустраивать свой дом на своей территории. Тебя конечно всё равно могут ограбить, но ты сможешь наказать обидчика. Закон на твоей стороне. Если хочешь можешь сходить к мяснику, он кажется хотел тебе что-то сказать."
    },
    "tp-return-home": {
