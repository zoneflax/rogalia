...
function Quests() {
    return {
        "tutorial-start": {
            ...
            final: {
                "en": "",
                "ru": "Что, решил остаться? Отлично. Запоминай: <i>до 10 уровня на тебя не нападут дикие животные, а при смерти ты останешься со своей сумкой.</i>",
            },
        },
        "craft-1": {
            name: {
            ...
            tip: {
                "en": "",
                "ru": "По дереву ПКМ -> Собрать ветку  или сук. Собрать камни с земли ЛКМ.",
            },
            final: {
                "en": "",
                "ru": "",
        ...
        "craft-2": {
            ...
            tip: {
                "en": "",
                "ru": "На панели права есть кнопка \"Крафт\", нужный рецепт можно найти в поиске по названию или по ресурсу, можно использовать фильтры. ПКМ -> Сломать по суку даст возможность сделать из него палку; ПКМ по ветке -> Сломать, получится прутик.",
            },
            final: {
                "en": "",
                "ru": "",
        ...
        "stat-1": {
            ...
            tip: {
                "en": "",
                "ru": "На правой панели кнопка \"Статы\", там приведена вся информация по персонажу. ПКМ по кружке -> Пить, для того чтобы наполнить ёмкость водой, нужно стоять на мелководье.",
            },
            final: {
                "en": "",
                "ru": "",
