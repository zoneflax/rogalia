function Talks() {
    return {
        ...
        "shot": [
            ...
            "Наш трактир «Гарцующий Койот», пожалуй, единственное место, которое заслуживает внимания в этом городке, что бы там ни говорил этот задавака Чарльз.",
            "У нас есть еда, вода и кое-что погорячее в соседней комнате. Но, я думаю, ты и без меня разберёшься.",
            {
        ...
        "margo": [
            ...
            "Давай повеселимся немного, ты же знаешь кто я, не правда ли? Вы называете нас «mulier stupri», но мне больше нравится «ночная бабочка», я же похожа на бабочку правда? Шелковистые крылышки, лёгкость во всём теле, необычайная красота, а главное… Я тоже дарю людям удовольствие… Особое удовольствие.",
            "Так что, ты просто поглазеть пришёл или даже такой крепкий парень как ты нуждается иногда в отдыхе?",
            {
        ...
        "bruno": [
            "Ээээ… Парень, ты меня ни с кем не попутал? Я вроде не вызывался нянькой работать.",
            "Или… А! Эээ, ну в общем, добро пожаловать в мой магазин. Тут у меня… Ээээ… Да, тут у меня всякие штуки, чтобы быть портным, а там, в соседнем помещении, моя любимая кузница.",
            "Ну, ты типа тут вроде новенький, поэтому можешь моими инструментами бесплатно пользоваться пока. Только смотри ничего не сломай! Я с тебя кожу сдеру и мешочки из неё сделаю! Ээээ… Ну, или просто выпишу штраф… Посмотрим… ",
            "В общем, обращайся, если что-то понадобиться.",
            {
                "Buy": "Купить камней",
                "Quest": "Квест.",
            }
